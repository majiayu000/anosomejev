...
## Critique bullets anosomejev should pin

1. Pin official jaggedness + launch-post nuance boxes.  
2. Pin HN 49717558 with “read before believing 200×.”  
3. Separate tags: `schema-guarantee` vs `task-accuracy` vs `calibration`.  
4. Include **negative results** (phishing bench Haiku wins; finance “no alpha”; chess evals weak).  
5. Document Every protocol as the default “try this first” independent smoke test.
