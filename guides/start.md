...
[SDK 与接入](../README_zh.md#sdk-与接入) · [路由实践](../patterns/routing.md) · [评分实践](../patterns/scoring.md) · [候选发现](../research/DISCOVERY.md)

API and conceptual references checked on 2026-09-19. Live API execution and project benchmarks were not performed for this guide.
